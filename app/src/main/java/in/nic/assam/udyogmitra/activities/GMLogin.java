...
//        DataBaseHelper myDbHelper = new DataBaseHelper(GMLogin.this);
        new Handler().postDelayed(() -> myDbHelper = new DataBaseHelper(GMLogin.this), 1000);
...
//                    String district_name = loginRequest(str_userName,str_password);
                ...
                if(result){
                    ...
                    bundle.putString("gm_district", district_name);
                    bundle.putString("gm_name", gmDetails.getName());
                    bundle.putString("gm_id", gmDetails.getId());
                    // passing the bundle into the intent
                    intentGMLogin.putExtras(bundle);
